...
for filename in os.listdir(input_folder):
    ...
    with open(position_file, "r") as archivo_pos:
        ...
        for line in reversed(lines):
            if line.strip() and not line.startswith('%'):
                ...
                if len(data) == 19:  # Hay 20 elementos en lugar de 18 debido a la estructura de latitud y longitud
                    ...
                    break
        # Guardo los valores de latitudes, longitudes y altura en las listas definidas al comienzo.
        for line in lines:
            if line.strip() and not line.startswith('%'):
                data = line.split()
        ...
        # Convierto los valores angulares a grados minutos y segundos
        ...
        # Guardo los promedios, las desviaciones y los errores de las desviaciones en un archivo.
    ...
    # Funcion para graficar los datos en 3D
